...
export function AboutSection() {
  return (
    <div className="h-full py-16 px-4  bg-[url('/banner-2.png')] bg-center object-contain text-white">
      <div className="mx-auto max-w-7xl grid grid-cols-1 sm:grid-cols-2 place-content-center gap-2">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <p className="text-sx sm:text-sm font-light">
            O Yah Acqua Park é o mais novo complexo de entretenimento do Piauí,
            pronto para te surpreender com uma estrutura moderna, segura e
            pensada para criar memórias inesquecíveis.
          </p>
        </div>
      </div>
    </div>
